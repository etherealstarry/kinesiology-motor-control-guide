# KINE 689: Special Topics in...

> 专题研讨课（博士高级选修） | 1-4 学分 | 每学期
...
| 学分 | 1-4 |
| 学期 | 按需开设，每学期专题不同 |
| 形式 | 围绕教授当前研究方向开设的特殊专题 |
| 适合 | Motor Neuroscience PhD 的 "Advisor Directed Elective" |
...
| 专题名称 | 学分 | 与你方向匹配度 |
|----------|:---:|:---:|
| **Non-Invasive Brain Stimulation: From Basic Science to Clinical Practice** | 3 | ⭐⭐⭐⭐⭐ |
| **Neuromechanics Research Methods** | 3 | ⭐⭐⭐⭐ |
| **Neuromechanics Data Analysis** | 3 | ⭐⭐⭐⭐ |
...
1. 每学期具体开什么专题**不固定**
2. 开学前登录 **Howdy Portal** → Schedule of Classes 查当期 KINE 689 的 Section 标题
3. 优先抢「Non-Invasive Brain Stimulation」——和 TMS 研究方向完全匹配
4. 如果没有神经调控相关专题，联系导师提议 KINE 685 (Directed Studies) 替代
